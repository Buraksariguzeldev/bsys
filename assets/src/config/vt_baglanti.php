...
try {
    ...
    $vt = new PDO('mysql:host=localhost;dbname=bsys;charset=utf8', 'root', '');
    ...
    try {
        ...
        $vt = new
        PDO('mysql:host=sql308.infinityfree.com;dbname=if0_38060032_bsysp;charset=utf8',
        'if0_38060032', 'MfDL8PZnpqC3dyR');
